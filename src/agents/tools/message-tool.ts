...
function appendMessageToolVisibleReplyHint(
  ...
  return `${description} For this turn, use action="send" with message for visible replies to the current source conversation. ${targetGuidance} Normal final answers may stay private or route only as a fallback.`;
}
