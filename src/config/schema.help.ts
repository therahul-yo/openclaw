...
export const FIELD_HELP: Record<string, string> = {
  ...
  "messages.visibleReplies":
    'Controls visible source replies across direct, group, and channel conversations. "message_tool" prefers message(action=send) for visible output; normal group/channel requests can fall back to final text, while direct/tool-strict routes keep finals private. "automatic" posts normal replies as before.',
  ...
  "messages.groupChat.visibleReplies":
    'Overrides visible source replies for group/channel conversations. Defaults to "message_tool" when no global visible reply policy is set. "message_tool" prefers message(action=send) for room output and falls back to final text for normal requests; ambient room events stay strict. "automatic" posts normal replies as before.',
  "messages.queue":
